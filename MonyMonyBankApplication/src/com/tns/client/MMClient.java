...
public class MMClient {
	...
	public static void main(String[] args) {
		...
		MMCurrentAcc gsn=(MMCurrentAcc)factory.getNewCurrentAccount(895581212, "Ahmad", 6040.00f);
		gsn.withdraw(gsn.getAccBal());
		MMSavingAcc gsp=(MMSavingAcc) factory.getNewSavingAccount(1218529622, "Khan", 5000.00f, true);
